...
DAMAGE_TOOL_MAP: dict[str, list[dict]] = {
    "front_damage": [
        ...
        {"category": "Power Units", "tool": "Hydraulic Power Unit", "priority": "CRITICAL", "reason": "Required to operate hydraulic rescue tools."},
        {"category": "Hoses", "tool": "High-Pressure Hydraulic Hose Set", "priority": "HIGH", "reason": "Connects the power unit to cutters, spreaders, and rams."},
        {"category": "Lifting Equipment", "tool": "Vehicle Stabilisation Kit", "priority": "CRITICAL", "reason": "Vehicle must be stabilized before extrication work begins."},
    ],
    "side_damage": [
        ...
        {"category": "Power Units", "tool": "Hydraulic Power Unit", "priority": "CRITICAL", "reason": "Powers hydraulic extraction tools."},
        {"category": "Hoses", "tool": "High-Pressure Hydraulic Hose Set", "priority": "HIGH", "reason": "Connects hydraulic tools to the power source."},
    ...
    "rear_damage": [
        ...
        {"category": "Power Units", "tool": "Hydraulic Power Unit", "priority": "HIGH", "reason": "Powers rescue tools."},
    ...
    "pillar_damage": [
        ...
        {"category": "Combi Tools", "tool": "Combi Cutter-Spreader", "priority": "CRITICAL", "reason": "Useful for fast structural removal and access creation."},
        {"category": "Spreaders", "tool": "Hydraulic Spreader (Jaws of Life)", "priority": "CRITICAL", "reason": "Opens crushed pillar sections and structural gaps."},
        {"category": "Rescue Rams", "tool": "Hydraulic Rescue Ram", "priority": "CRITICAL", "reason": "Can help move collapsed structural sections away from the occupant."},
        ...
        {"category": "Power Units", "tool": "Hydraulic Power Unit", "priority": "CRITICAL", "reason": "Required for all hydraulic operations."},
        {"category": "Hoses", "tool": "High-Pressure Hydraulic Hose Set", "priority": "HIGH", "reason": "Connects rescue tools to the power unit."},
    ...
    "roof_damage": [
        ...
        {"category": "Power Units", "tool": "Hydraulic Power Unit", "priority": "CRITICAL", "reason": "Powers the hydraulic rescue system."},
        {"category": "Hoses", "tool": "High-Pressure Hydraulic Hose Set", "priority": "HIGH", "reason": "Connects the power unit to rescue devices."},
